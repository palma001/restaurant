        ...
        <div class="slimscroll-menu">
            ...
            <div id="sidebar-menu">
                <ul class="metismenu" id="side-menu">
                   ...
                   <li>
                        <a href="<?php echo base_url().'index.php/products';?>" aria-expanded="false">
                    ...
                    <li>
                        <a href="<?php echo base_url('index.php/settings/index/');?>"> <i class="fe-settings"></i> Settings </a>      
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo base_url('index.php/Sliders/index/');?>"> <i class="fe-sliders"></i> Sliders </a>
                </ul>
            </div>
            <!-- End Sidebar -->
