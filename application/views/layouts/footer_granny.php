		...
		<!-- RS5.0 Core JS Files -->
		<script src="<?php echo base_url('granny/assets/revolution/js/jquery.themepunch.tools.min.js?rev=5.0'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/revolution/js/jquery.themepunch.revolution.min.js?rev=5.0'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/revolution/js/extensions/revolution.extension.video.min.js'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/revolution/js/extensions/revolution.extension.slideanims.min.js'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/revolution/js/extensions/revolution.extension.actions.min.js'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/revolution/js/extensions/revolution.extension.layeranimation.min.js'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/revolution/js/extensions/revolution.extension.kenburn.min.js'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/revolution/js/extensions/revolution.extension.navigation.min.js'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/revolution/js/extensions/revolution.extension.migration.min.js'); ?>"></script>
		<script src="<?php echo base_url('granny/assets/assets/revolution/js/extensions/revolution.extension.parallax.min.js'); ?>"></script>
		<!-- RS Configration JS Files -->
		<script src="<?php echo base_url('granny/assets/js/rsconfig.js'); ?>"></script>
	</body>
</html>