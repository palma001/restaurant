...
<html>
	<head>
        ...
        <link href="<?php echo base_url('admin_template/css/vendor/select.bootstrap4.css');?>" rel="stylesheet" type="text/css" />
		<script src="<?php echo base_url('admin_template/js/vendor.min.js')?>"></script>
        <script src="<?php echo  base_url('admin_template/js/js_core.js')?>"></script> 
	</head>
	<body>
