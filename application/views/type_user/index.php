                               			...
                               			foreach ($user_types->result() as $key => $user_types) {
		                               		echo '
												<tr>
													...
													<td>
														<a href="'.base_url()."index.php/typeUser/show/".$user_types->user_type_id.'" class="btn btn-sm btn-dark"><i class="fe-edit"></i></a>
														<a href="'.base_url()."index.php/typeUser/destroy/".$user_types->user_type_id.'" class="btn btn-sm btn-danger"><i class="fe-trash"></i></a>
													</td>
												</tr>
		                               		';
	                               		} 
