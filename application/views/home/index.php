		...
		<div id="slider1" class="rev_slider"  data-version="5.0">
			<ul>
				...
				<li data-transition="zoomin"
					...
					<!-- MAIN IMAGE -->
					<img src="<?php echo base_url('granny/assets/images/sliders/slide-bg/11.jpg'); ?>" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
				...
				<li data-transition="slideoverdown"
					...
					data-masterspeed="2000">
					<!-- MAIN IMAGE -->
					<img src="<?php echo base_url('granny/assets/images/sliders/slide-bg/3.jpg'); ?>" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption"
						data-x="center" data-hoffset="0"
						data-y="center" data-voffset="-130"
				...
				<li data-transition="incube-horizontal"
					...
					data-masterspeed="2000">
					<!-- MAIN IMAGE -->
					<img src="<?php echo base_url('granny/assets/images/sliders/slide-bg/12.jpg'); ?>" alt="Slide Background Image"  width="1920" height="1280">
					<!-- LAYER NR. 1 -->
					<div class="tp-caption"
						data-x="center" data-hoffset="0"
						data-y="center" data-voffset="-65"
