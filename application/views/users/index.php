                                       ...
                                       foreach ($users->result() as $key => $users) {
                                        echo '
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="'.base_url('index.php/TypesUsers/edit/'.$users->user_id).'"><i class="fe-edit-2"></i> </a>
                                                    <a href="'.base_url('index.php/TypesUsers/destroy/'.$users->user_id).'"> <i class="fe-x"></i></a>
                                                </td>
                                            </tr>
                                        ';
                                       }
