                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo base_url()."index.php/customers";?>" title="">Customer</a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            ?>
                            <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/customers/store/'); ?>">
                                            ...
                                            <?php  
                                                if ($users_types) {
                                                   foreach ($users_types->result() as $key => $users_types) {
                                                       echo '
                                                           <option value="'.$users_types->user_type_id.'">'.ucwords($users_types->user_type).'
                                                           </option>
                                                        ';
                                                   }
                                                }
