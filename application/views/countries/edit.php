            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Modify Country</h4>
                    </div>
                </div>
            </div> 
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                ?>
                                <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/Countries/update/'.$countries->country_id);?>">
                                    <div class="form-group row">
                                        <label class="col-sm-2 col-form-label">Country</label>
                                        <div class="col-sm-10">
                                            <input name="country" placeholder="Country"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?php echo $countries->country;?>">
                                        </div>
                                    </div>
                                    <div class="form-group row">
